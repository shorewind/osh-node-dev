...
public class Output extends AbstractSensorOutput<Sensor> implements Runnable {
    ...
    void doInit() {
        ...
        SWEHelper sweFactory = new GeoPosHelper();
    ...
    public void run() {
        ...
        try {
            ...
            while (processSets) {
                ...
                parentSensor.getLogger().trace(String.format(
                        "temp=%5.2f, press=%4.2f, wind speed-%5.2f, wind dir=%3.1f", temp, press, windSpeed, windDir));
