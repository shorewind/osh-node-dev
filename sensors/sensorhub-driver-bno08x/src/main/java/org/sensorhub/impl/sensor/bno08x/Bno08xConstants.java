...
public class Bno08xConstants
{
    public static final byte START_BYTE = (byte)0x14;  // Start byte for I2C communication
    public static final byte DATA_READ = (byte)0x80;   // Read command identifier
    public static final byte ACCEL_DATA_ADDR = 0x50;      // Accelerometer Data Address
    public static final byte MAG_DATA_ADDR = 0x2E;        // Magnetometer Data Address
    public final static byte QUAT_DATA_ADDR = 0x02;
    public final static byte[] ENABLE_MAG_CMD = {
